...
from lightning.pytorch.loggers import TensorBoardLogger  # Import TensorBoard logger
import optuna
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(direction="maximize", pruner=pruner, storage="postgresql+psycopg2://optuna_user:optuna_password@localhost:5432/optuna_db")
